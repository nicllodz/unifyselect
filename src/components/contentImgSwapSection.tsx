...
export default function EmployerSolutionSection({
  ...
  return (
    <section
      className={`bg-[#f9f9f9] rounded-3xl swap-col-section flex flex-col lg:flex-row items-stretch gap-20 my-16 w-[90%] mx-auto 
    ...
    >
      ...
      {/* Text Column */}
      <div className="w-full lg:w-1/2 p-20 text-col">
        <h2 className="text-3xl mb-5 text-[42px] font-[Lato] text-gray-900">{headline}</h2>
        <p className="text-light-blue-theme text-2xl mb-4">{subheading}</p>
        <div className="text-gray-800 text-2xl mb-10">{body}</div>
        {ctaText && (
          <a
            href={ctaLink || "#"}
